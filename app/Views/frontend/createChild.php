...
<div class="container-fluid childMain">
  <div class="row formCrEd">    
    ...
    <form method="post" class="childForm" >
      <h1 class="h1Create">CREATION D'UNE FICHE ENFANT</h1>      
      <div class="reducePCC">Seuls les champs marqués d'un astérisque sont obligatoires.</div> 
        ...
        <!--***********************HEALTH********************-->                
          ...
          <div id="smallC" class="collapse">Sélectionnez le médicament en cliquant dessus lorsque la liste s'affichera au fur et à mesure de vos entrées</div><br /> 
