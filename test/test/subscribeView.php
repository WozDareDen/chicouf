    ...
    <div class="col-lg-12">
        <form method="post" action="../../index.php?action=addUser">
          <div class="form-group  col-lg-12">
            ...
            <input type="text" id="username" name="firstNameCo" required="valid" placeholder="entrez votre nom" > 
          </div>
          <div class="form-group col-lg-12">
            <label for="username">Prénom</label><br />
            <input type="text" id="username" name="lastNameCo" required="valid" placeholder="entrez votre prénom" > 
          </div>
          <div class="form-group col-lg-12">
