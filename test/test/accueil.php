    ...
    <div class="container-fluid">
        ...
        <div class="pos-f-t">
            <div class="collapse" id="navbarToggleExternalContent">
                ...
                <h4 class="text-white">CHICOUF</h4>
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        ...
        <div class="row">
            <div class="alert alert-success col-lg-4 alert-dismissible fade show" data-dismiss="alert" role="alert">
            <h4 class="alert-heading">Félicitations !</h4>
            <p>Vous venez de créer une fiche enfant.</p>
            <hr>
            <p class="mb-0">Vous pouvez dès à present gérer son profil via votre espace membre.</p>
            </div>
        </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Et votre mot de passe">
  </div>
